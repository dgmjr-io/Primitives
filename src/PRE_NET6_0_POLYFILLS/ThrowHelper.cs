...
internal static class ThrowHelper
{
    ...
    ThrowInvalidTypeWithPointersNotSupported(Type targetType)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowArgumentException_CannotExtractScalar(ExceptionArgument argument)
    {
        throw GetArgumentException(ExceptionResource.Argument_CannotExtractScalar,
                                   argument);
    }
    ...
    {
        throw GetArgumentOutOfRangeException(
            ExceptionArgument.year, ExceptionResource.ArgumentOutOfRange_Year);
    }
    ...
    {
        throw new ArgumentOutOfRangeException("dayNumber", dayNumber,
    ...
    {
        throw new ArgumentOutOfRangeException(
            null, SR.ArgumentOutOfRange_BadYearMonthDay);
    }
    ...
    {
        throw new ArgumentOutOfRangeException(
            null, SR.ArgumentOutOfRange_BadHourMinuteSecond);
    }
    ...
    [DoesNotReturn]
    internal static void ThrowArgumentOutOfRange_Range<T>(string parameterName,
                                                          T value, T minInclusive,
                                                          T maxInclusive)
    {
        throw new ArgumentOutOfRangeException(
            parameterName, value,
    ...
    [DoesNotReturn]
    internal static void ThrowWrongKeyTypeArgumentException<T>(T key,
                                                               Type targetType)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowWrongValueTypeArgumentException<T>(T value, Type targetType)
    {
    ...
    GetAddingDuplicateWithKeyArgumentException(object key)
    {
        return new ArgumentException(
            SR.Format(SR.Argument_AddingDuplicateWithKey, key));
    }
    ...
    [DoesNotReturn]
    internal static void
    ThrowArgumentOutOfRangeException(ExceptionArgument argument, int paramNumber,
                                     ExceptionResource resource)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowInvalidOperationException(ExceptionResource resource)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowInvalidOperationException(ExceptionResource resource, Exception e)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowObjectDisposedException_StreamClosed(string objectName)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowObjectDisposedException(ExceptionResource resource)
    {
    ...
    {
        throw new ArgumentOutOfRangeException(
            "state", state, SR.Argument_UnexpectedStateForKnownCallback);
    }
    ...
    [DoesNotReturn]
    internal static void
    ThrowArraySegmentCtorValidationFailedExceptions(Array array, int offset,
                                                    int count)
    {
    ...
    [DoesNotReturn]
    internal static void
    ThrowFormatException_BadBoolean(ReadOnlySpan<char> value)
    {
        throw new FormatException(
            SR.Format(SR.Format_BadBoolean, new string(value.ToArray())));
    }
    ...
    {
        throw new ArgumentOutOfRangeException(
            "precision", SR.Format(SR.Argument_PrecisionTooLarge, (byte)99));
    }
    ...
    [DoesNotReturn]
    internal static void
    ThrowArgumentOutOfRangeException_NeedNonNegNum(string paramName)
    {
    ...
    [DoesNotReturn]
    internal static void ThrowFormatInvalidString(int offset,
                                                  ExceptionResource resource)
    {
        throw new FormatException(
            SR.Format(SR.Format_InvalidStringWithOffsetAndReason, offset,
                      GetResourceString(resource)));
    }
    ...
    GetArraySegmentCtorValidationFailedException(Array array, int offset,
                                                 int count)
    {
        if (array == null)
        {
        ...
        if (offset < 0)
        {
            return new ArgumentOutOfRangeException(
                "offset", SR.ArgumentOutOfRange_NeedNonNegNum);
        }
        if (count < 0)
        {
            return new ArgumentOutOfRangeException(
                "count", SR.ArgumentOutOfRange_NeedNonNegNum);
        }
        return new ArgumentException(SR.Argument_InvalidOffLen);
    }

    private static ArgumentException
    GetArgumentException(ExceptionResource resource)
    {
        return new ArgumentException(GetResourceString(resource));
    }

    private static InvalidOperationException
    GetInvalidOperationException(ExceptionResource resource)
    {
        return new InvalidOperationException(GetResourceString(resource));
    }

    private static ArgumentException
    GetWrongKeyTypeArgumentException(object key, Type targetType)
    {
        return new ArgumentException(SR.Format(SR.Arg_WrongType, key, targetType),
                                     "key");
    }

    private static ArgumentException
    GetWrongValueTypeArgumentException(object value, Type targetType)
    {
        return new ArgumentException(SR.Format(SR.Arg_WrongType, value, targetType),
                                     "value");
    }
    ...
    private static ArgumentException
    GetArgumentException(ExceptionResource resource, ExceptionArgument argument)
    {
        return new ArgumentException(GetResourceString(resource),
    ...
    private static ArgumentOutOfRangeException
    GetArgumentOutOfRangeException(ExceptionArgument argument, int paramNumber,
                                   ExceptionResource resource)
    {
        return new ArgumentOutOfRangeException(GetArgumentName(argument) + "[" +
                                                   paramNumber + "]",
    ...
    private static InvalidOperationException
    GetInvalidOperationException_EnumCurrent(int index)
    {
        return new InvalidOperationException(
            (index < 0) ? SR.InvalidOperation_EnumNotStarted
                        : SR.InvalidOperation_EnumEnded);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static void
    IfNullAndNullsAreIllegalThenThrow<T>(object value,
    ...
    private static string GetResourceString(ExceptionResource resource)
    {
        return resource switch
        {
            ...
            ExceptionResource.Arg_ByteArrayTooSmallForValue =>
                SR.Arg_ByteArrayTooSmallForValue,
            ...
            ExceptionResource.ArgumentOutOfRange_ListInsert =>
                SR.ArgumentOutOfRange_ListInsert,
            ExceptionResource.ArgumentOutOfRange_NeedNonNegNum =>
                SR.ArgumentOutOfRange_NeedNonNegNum,
            ...
            ExceptionResource.Argument_CannotExtractScalar =>
                SR.Argument_CannotExtractScalar,
            ...
            ExceptionResource.Task_Start_ContinuationTask =>
                SR.Task_Start_ContinuationTask,
            ExceptionResource.Task_Start_AlreadyStarted =>
                SR.Task_Start_AlreadyStarted,
            ExceptionResource.Task_RunSynchronously_Continuation =>
                SR.Task_RunSynchronously_Continuation,
            ExceptionResource.Task_RunSynchronously_Promise =>
                SR.Task_RunSynchronously_Promise,
            ...
            ExceptionResource.Task_ContinueWith_ESandLR =>
                SR.Task_ContinueWith_ESandLR,
            ExceptionResource.Task_ContinueWith_NotOnAnything =>
                SR.Task_ContinueWith_NotOnAnything,
            ExceptionResource.Task_InvalidTimerTimeSpan =>
                SR.Task_InvalidTimerTimeSpan,
            ExceptionResource.Task_Delay_InvalidMillisecondsDelay =>
                SR.Task_Delay_InvalidMillisecondsDelay,
            ExceptionResource.Task_Dispose_NotCompleted =>
                SR.Task_Dispose_NotCompleted,
            ...
            ExceptionResource.Argument_AlignmentMustBePow2 =>
                SR.Argument_AlignmentMustBePow2,
            ...
            ExceptionResource.Format_UnexpectedClosingBrace =>
                SR.Format_UnexpectedClosingBrace,
            ExceptionResource.Format_UnclosedFormatItem =>
                SR.Format_UnclosedFormatItem,
            ExceptionResource.Format_ExpectedAsciiDigit =>
                SR.Format_ExpectedAsciiDigit,
            _ => "",
        };
    }
}
