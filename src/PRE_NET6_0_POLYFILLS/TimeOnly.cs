...
using TimeOnlyTuple = (long ticks, int hour, int minute, int second, int milli, int micro);
...
namespace System
{
                                    ...
                                    //IUtf8SpanFormattable
    {
        ...
        {
            TimeOnlyTuple validation = ValidateInputs(hour, minute, second, millisecond, 0);
        ...
        /// <summary>
        /// Initializes a new instance of the TimeOnly structure to the specified hour and minute, and zero seconds, milliseconds and microseconds.
        /// </summary>
        /// <param name="hour">The hours (0 through 23).</param>
        /// <param name="minute">The minutes (0 through 59).</param>
