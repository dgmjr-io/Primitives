...
internal sealed class _ResourceReader : IResourceReader,
                                        IEnumerable,
                                        IDisposable
{
                                               ...
                                               IEnumerator
    {
        ...
        public DictionaryEntry Entry
        {
            get
            {
                ...
                string? key =
                    _reader.AllocateStringForNameIndex(_currentName, out _dataPosition);
                object? obj = null;
        ...
        {
            if (_currentName == _reader._numResources - 1 ||
    ...
    internal static bool AllowCustomResourceTypes
    {
        get;
    } =
    ...
    internal _ResourceReader(Stream stream,
    ...
    private object DeserializeObject(int typeIndex)
    {
        ...
        if (!_permitDeserialization)
        {
            throw new NotSupportedException(
                SR.NotSupported_ResourceObjectSerialization);
        }
        if (Volatile.Read(ref _binaryFormatter) == null &&
        ...
        if (obj.GetType() != type)
        {
            throw new BadImageFormatException(
                SR.Format(SR.BadImageFormat_ResType_SerBlobMismatch, type.FullName,
    ...
    {
        if ((object)Volatile.Read(ref s_binaryFormatterType) == null ||
            Volatile.Read(ref s_deserializeMethod) == null)
        {
            Type? type = Type.GetType(
                "System.Runtime.Serialization.Formatters.Binary.BinaryFormatter, System.Runtime.Serialization.Formatters",
                throwOnError: true);
            MethodInfo? method =
                type.GetMethod("Deserialize", new Type[1] { typeof(Stream) });
            MethodInfo? method2 = typeof(_ResourceReader)!.GetMethod(
        ...
        Volatile.Write(ref _binaryFormatter,
                       Activator.CreateInstance(s_binaryFormatterType));
        return s_deserializeMethod != null;
    }

    private static Func<object, Stream, object>
    CreateUntypedDelegate<TInstance>(MethodInfo method)
    {
        Func<TInstance, Stream, object> typedDelegate =
            (Func<TInstance, Stream, object>)Delegate.CreateDelegate(
                typeof(Func<TInstance, Stream, object>), null, method);
    ...
    private static bool ValidateReaderType(string readerType)
    {
        ...
        // return ResourceManager.IsDefaultType(readerType,
                                ...
                                out byte[] resourceData)
    {
        ...
        if (num == -1)
        {
            throw new ArgumentException(
                SR.Format(SR.Arg_ResourceNameNotExist, resourceName));
        }
        lock (this)
        {
            for (int i = 0; i < _numResources; i++)
            {
                ...
                if (num2 < 0)
                {
                    throw new FormatException(
                        SR.Format(SR.BadImageFormat_ResourcesNameInvalidOffset, num2));
                }
                ...
                {
                    throw new FormatException(
                        SR.Format(SR.BadImageFormat_ResourcesDataInvalidOffset, num3));
                }
                array[i] = num3;
            }
            Array.Sort(array);
            ...
            long num5 =
                ((num4 < _numResources - 1) ? (array[num4 + 1] + _dataSectionOffset)
                                            : _store.BaseStream.Length);
            int num6 = (int)(num5 - (num + _dataSectionOffset));
            _store.BaseStream.Position = _dataSectionOffset + num;
            ResourceTypeCode resourceTypeCode =
                (ResourceTypeCode)_store.Read7BitEncodedInt();
            if (resourceTypeCode < ResourceTypeCode.Null ||
    ...
    public void Close() { Dispose(disposing: true); }
    ...
    {
        int num = ((_ums != null) ? ReadUnalignedI4(_namePositionsPtr + index)
                                  : _namePositions[index]);
        if (num < 0 || num > _dataSectionOffset - _nameSectionOffset)
        {
            throw new FormatException(
                SR.Format(SR.BadImageFormat_ResourcesNameInvalidOffset, num));
        }
        return num;
    }
    ...
    internal int FindPosForResource(string name)
    {
        ...
        lock (this)
        {
            ...
            {
                _store.BaseStream.Seek(_nameSectionOffset + GetNamePosition(j),
                                       SeekOrigin.Begin);
                if (CompareStringEqualsName(name))
                {
                    int num5 = _store.ReadInt32();
                    if (num5 < 0 ||
                        num5 >= _store.BaseStream.Length - _dataSectionOffset)
                    {
                        throw new FormatException(
                            SR.Format(SR.BadImageFormat_ResourcesDataInvalidOffset, num5));
                    }
                    return num5;
                }
            }
    ...
    private unsafe bool CompareStringEqualsName(string name)
    {
        ...
        if (_ums != null)
        {
            ...
            return FastResourceComparer.CompareOrdinal(positionPointer, num, name) ==
                   0;
        }
                                                     ...
                                                     out int dataOffset)
    {
        ...
        lock (this)
        {
            ...
            while (num3 > 0)
            {
                ...
                if (num4 == 0)
                {
                    throw new EndOfStreamException(SR.Format(
    ...
    private object? GetValueForNameIndex(int index)
    {
        ...
        lock (this)
        {
            ...
            {
                throw new FormatException(
                    SR.Format(SR.BadImageFormat_ResourcesDataInvalidOffset, num2));
            }
            if (_version == 1)
            {
    ...
    internal string? LoadString(int pos)
    {
        lock (this)
        {
            ...
            if (_version == 1)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.Format(SR.InvalidOperation_ResourceNotString_Type,
            ...
            else
            {
                    ...
                    resourceTypeCode != 0)
                {
                    throw new InvalidOperationException(SR.Format(
                        ...
                        resourceFormat: SR.InvalidOperation_ResourceNotString_Type));
                }
                if (resourceTypeCode == ResourceTypeCode.String)
                {
                    result = _store.ReadString();
    ...
    internal object? LoadObject(int pos)
    {
        ...
        {
            ResourceTypeCode typeCode;
            return (_version == 1) ? LoadObjectV1(pos)
                                   : LoadObjectV2(pos, out typeCode);
        }
    }
    ...
    internal object? LoadObject(int pos, out ResourceTypeCode typeCode)
    {
        lock (this)
        {
            if (_version == 1)
            {
                ...
                typeCode = ((obj is string) ? ResourceTypeCode.String
            ...
            case ResourceTypeCode.Stream:
                {
                    ...
                    return new UnmanagedMemoryStream(_ums.PositionPointer, num, num,
                                                     FileAccess.Read);
                }
            default:
                {
    ...
    private void ReadResources()
    {
        ...
        {
            throw new BadImageFormatException(
                SR.BadImageFormat_ResourcesHeaderCorrupted, inner);
        }
        catch (IndexOutOfRangeException inner2)
        {
            throw new BadImageFormatException(
                SR.BadImageFormat_ResourcesHeaderCorrupted, inner2);
        }
    }
    ...
    private unsafe void _ReadResources()
    {
        ...
        else
        {
            ...
            {
                throw new NotSupportedException(
                    SR.Format(SR.NotSupported_WrongResourceReader_Type, text));
            }
            SkipString();
        }
        ...
        {
            throw new ArgumentException(
                SR.Format(SR.Arg_ResourceFileUnsupportedVersion, 2, num4));
        }
        _version = num4;
    ...
    private Type UseReflectionToGetType(int typeIndex)
    {
        ...
        try
        {
          ...
          when (!_permitDeserialization)
        {
            throw new NotSupportedException(
                SR.NotSupported_ResourceObjectSerialization, innerException);
        }
        finally
        {
