...
internal sealed class RuntimeResourceSet : ResourceSet, IEnumerable
{
        ...
        : base()
    {
        ...
        _defaultReader =
            new _ResourceReader(stream, _resCache, permitDeserialization);
    }
    ...
    private object? GetObject(string key, bool ignoreCase, bool isString)
    {
        ...
        lock (resCache)
        {
            ...
            if (resCache.TryGetValue(key, out value))
            {
                ...
                return isString ? defaultReader.LoadString(dataPosition)
            ...
            {
                object? value2 =
                    ReadValue(defaultReader, dataPosition, isString, out value);
                resCache[key] = value;
                return value2;
            }
        }
        ...
        if (dictionary == null)
        {
            dictionary = new Dictionary<string, ResourceLocator>(
        ...
        lock (dictionary)
        {
            if (flag)
            {
                ...
                while (enumeratorInternal.MoveNext())
                {
                    ...
                    ResourceLocator value3 =
                        new ResourceLocator(enumeratorInternal.DataPosition, null)!;
            ...
            object? value2 =
                ReadValue(defaultReader, value.DataPosition, isString, out value);
            if (value.Value != null)
            {
    ...
    private static object? ReadValue(_ResourceReader reader, int dataPos,
                                     bool isString, out ResourceLocator locator)
    {
        object? obj;
        ...
        locator = new ResourceLocator(
            dataPos, ResourceLocator.CanCache(typeCode) ? obj : null);
        return obj;
    }
}
#endif
