...
public static class SR
{
    ...
    public static ResourceManager ResourceManager =>
        s_resourceManager ??
        (s_resourceManager = new ResourceManager(typeof(SR)));
    ...
    public const string AggregateException_InnerException =
        "AggregateException_InnerException";

    public const string AppDomain_Name = "AppDomain_Name";

    public const string AppDomain_NoContextPolicies =
        "AppDomain_NoContextPolicies";

    public const string AppDomain_Policy_PrincipalTwice =
        "AppDomain_Policy_PrincipalTwice";
    ...
    public const string Arg_AccessViolationException =
    ...
    public const string Arg_ArgumentOutOfRangeException =
    ...
    public const string Arg_ByteArrayTooSmallForValue =
        "Arg_ByteArrayTooSmallForValue";

    public const string Arg_ArrayTypeMismatchException =
    ...
    public const string Arg_BadImageFormatException =
    ...
    public const string Arg_CannotHaveNegativeValue =
    ...
    public const string Arg_CannotUnloadAppDomainException =
        "Arg_CannotUnloadAppDomainException";
    ...
    public const string Arg_CustomAttributeFormatException =
        "Arg_CustomAttributeFormatException";

    public const string Arg_DataMisalignedException =
    ...
    public const string Arg_DirectoryNotFoundException =
        "Arg_DirectoryNotFoundException";
    ...
    public const string Arg_DuplicateWaitObjectException =
    ...
    public const string Arg_EntryPointNotFoundException =
        "Arg_EntryPointNotFoundException";

    public const string Arg_EnumAndObjectMustBeSameType =
    ...
    public const string Arg_ExecutionEngineException =
    ...
    public const string Arg_HexBinaryStylesNotSupported =
    ...
    public const string Arg_IndexOutOfRangeException =
    ...
    public const string Arg_InvalidComObjectException =
        "Arg_InvalidComObjectException";

    public const string Arg_InvalidFilterCriteriaException =
        "Arg_InvalidFilterCriteriaException";
    ...
    public const string Arg_InvalidOleVariantTypeException =
        "Arg_InvalidOleVariantTypeException";

    public const string Arg_InvalidOperationException =
    ...
    public const string Arg_MarshalAsAnyRestriction =
        "Arg_MarshalAsAnyRestriction";

    public const string Arg_MarshalDirectiveException =
    ...
    public const string Arg_MulticastNotSupportedException =
    ...
    public const string Arg_MustBeEnumBaseTypeOrEnum =
    ...
    public const string Arg_NoDefCTorWithoutTypeName =
        "Arg_NoDefCTorWithoutTypeName";
    ...
    public const string Arg_NotFiniteNumberException =
        "Arg_NotFiniteNumberException";

    public const string Arg_NotGenericMethodDefinition =
        "Arg_NotGenericMethodDefinition";

    public const string Arg_NotGenericParameter = "Arg_NotGenericParameter";

    public const string Arg_NotGenericTypeDefinition =
        "Arg_NotGenericTypeDefinition";

    public const string Arg_NotImplementedException =
        "Arg_NotImplementedException";
    ...
    public const string Arg_ResourceFileUnsupportedVersion =
        "Arg_ResourceFileUnsupportedVersion";

    public const string Arg_ResourceNameNotExist = "Arg_ResourceNameNotExist";

    public const string Arg_SafeArrayRankMismatchException =
        "Arg_SafeArrayRankMismatchException";

    public const string Arg_SafeArrayTypeMismatchException =
        "Arg_SafeArrayTypeMismatchException";
    ...
    public const string Arg_SynchronizationLockException =
        "Arg_SynchronizationLockException";

    public const string Arg_SystemException = "Arg_SystemException";

    public const string Arg_TargetInvocationException =
        "Arg_TargetInvocationException";

    public const string Arg_TargetParameterCountException =
    ...
    public const string Arg_UnauthorizedAccessException =
    ...
    public const string Argument_AbsolutePathRequired =
    ...
    public const string Argument_BadFormatSpecifier =
    ...
    public const string Argument_BadNestedTypeFlags =
        "Argument_BadNestedTypeFlags";

    public const string Argument_BadParameterCountsForConstructor =
        "Argument_BadParameterCountsForConstructor";

    public const string Argument_BadParameterTypeForCAB =
    ...
    public const string Argument_BadTypeAttrInvalidLayout =
        "Argument_BadTypeAttrInvalidLayout";
    ...
    public const string Argument_BadTypeAttrReservedBitsSet =
        "Argument_BadTypeAttrReservedBitsSet";

    public const string Argument_BadTypeInCustomAttribute =
        "Argument_BadTypeInCustomAttribute";

    public const string Argument_CannotSetParentToInterface =
        "Argument_CannotSetParentToInterface";

    public const string Argument_CodepageNotSupported =
        "Argument_CodepageNotSupported";

    public const string Argument_CompareOptionOrdinal =
    ...
    public const string Argument_ConflictingDateTimeStyles =
        "Argument_ConflictingDateTimeStyles";

    public const string Argument_ConstantDoesntMatch =
        "Argument_ConstantDoesntMatch";

    public const string Argument_ConstantNotSupported =
        "Argument_ConstantNotSupported";
    ...
    public const string Argument_DateTimeBadBinaryData =
        "Argument_DateTimeBadBinaryData";

    public const string Argument_DateTimeHasTicks = "Argument_DateTimeHasTicks";

    public const string Argument_DateTimeHasTimeOfDay =
        "Argument_DateTimeHasTimeOfDay";

    public const string Argument_DateTimeIsInvalid = "Argument_DateTimeIsInvalid";

    public const string Argument_DateTimeIsNotAmbiguous =
        "Argument_DateTimeIsNotAmbiguous";
    ...
    public const string Argument_EmptyWaithandleArray =
        "Argument_EmptyWaithandleArray";

    public const string Argument_EncoderFallbackNotEmpty =
    ...
    public const string Argument_EncodingNotSupported =
        "Argument_EncodingNotSupported";

    public const string Argument_EnumTypeDoesNotMatch =
        "Argument_EnumTypeDoesNotMatch";

    public const string Argument_FallbackBufferNotEmpty =
        "Argument_FallbackBufferNotEmpty";

    public const string Argument_FieldDeclaringTypeGeneric =
        "Argument_FieldDeclaringTypeGeneric";

    public const string Argument_FieldNeedGenericDeclaringType =
        "Argument_FieldNeedGenericDeclaringType";

    public const string Argument_GenConstraintViolation =
        "Argument_GenConstraintViolation";
    ...
    public const string Argument_GlobalMembersMustBeStatic =
    ...
    public const string Argument_ImplementIComparable =
        "Argument_ImplementIComparable";

    public const string Argument_InvalidAppendMode = "Argument_InvalidAppendMode";

    public const string Argument_InvalidPreallocateAccess =
        "Argument_InvalidPreallocateAccess";

    public const string Argument_InvalidPreallocateMode =
        "Argument_InvalidPreallocateMode";

    public const string Argument_InvalidUnixCreateMode =
        "Argument_InvalidUnixCreateMode";

    public const string Argument_InvalidArgumentForComparison =
        "Argument_InvalidArgumentForComparison";

    public const string Argument_InvalidArrayLength =
        "Argument_InvalidArrayLength";

    public const string Argument_IncompatibleArrayType =
    ...
    public const string Argument_InvalidCharSequence =
        "Argument_InvalidCharSequence";

    public const string Argument_InvalidCharSequenceNoIndex =
        "Argument_InvalidCharSequenceNoIndex";

    public const string Argument_InvalidCodePageBytesIndex =
    ...
    public const string Argument_InvalidConstructorInfo =
        "Argument_InvalidConstructorInfo";

    public const string Argument_InvalidCultureName =
        "Argument_InvalidCultureName";

    public const string Argument_InvalidPredefinedCultureName =
        "Argument_InvalidPredefinedCultureName";

    public const string Argument_InvalidDateTimeKind =
        "Argument_InvalidDateTimeKind";

    public const string Argument_InvalidDateTimeStyles =
        "Argument_InvalidDateTimeStyles";

    public const string Argument_InvalidDateStyles = "Argument_InvalidDateStyles";

    public const string Argument_InvalidDigitSubstitution =
        "Argument_InvalidDigitSubstitution";

    public const string Argument_InvalidElementName =
        "Argument_InvalidElementName";

    public const string Argument_InvalidElementTag = "Argument_InvalidElementTag";

    public const string Argument_InvalidElementText =
        "Argument_InvalidElementText";

    public const string Argument_InvalidElementValue =
        "Argument_InvalidElementValue";
    ...
    public const string Argument_InvalidFieldDeclaringType =
        "Argument_InvalidFieldDeclaringType";
    ...
    public const string Argument_InvalidGenericInstArray =
        "Argument_InvalidGenericInstArray";
    ...
    public const string Argument_InvalidMethodDeclaringType =
        "Argument_InvalidMethodDeclaringType";

    public const string Argument_InvalidName = "Argument_InvalidName";

    public const string Argument_InvalidNativeDigitCount =
        "Argument_InvalidNativeDigitCount";

    public const string Argument_InvalidNativeDigitValue =
    ...
    public const string Argument_InvalidNumberStyles =
    ...
    public const string Argument_InvalidParameterInfo =
        "Argument_InvalidParameterInfo";
    ...
    public const string Argument_InvalidResourceCultureName =
        "Argument_InvalidResourceCultureName";

    public const string Argument_InvalidSafeBufferOffLen =
        "Argument_InvalidSafeBufferOffLen";

    public const string Argument_InvalidSeekOrigin = "Argument_InvalidSeekOrigin";

    public const string Argument_InvalidSerializedString =
        "Argument_InvalidSerializedString";

    public const string Argument_InvalidStartupHookSignature =
        "Argument_InvalidStartupHookSignature";

    public const string Argument_InvalidTimeSpanStyles =
    ...
    public const string Argument_MethodDeclaringTypeGeneric =
        "Argument_MethodDeclaringTypeGeneric";
    ...
    public const string Argument_MustBeRuntimeAssembly =
        "Argument_MustBeRuntimeAssembly";

    public const string Argument_MustBeRuntimeFieldInfo =
        "Argument_MustBeRuntimeFieldInfo";
    ...
    public const string Argument_MustHaveAttributeBaseClass =
        "Argument_MustHaveAttributeBaseClass";
    ...
    public const string Argument_NeedNonGenericType =
        "Argument_NeedNonGenericType";

    public const string Argument_NeedStructWithNoRefs =
        "Argument_NeedStructWithNoRefs";

    public const string Argument_NeverValidGenericArgument =
        "Argument_NeverValidGenericArgument";

    public const string Argument_NoEra = "Argument_NoEra";

    public const string Argument_NoRegionInvariantCulture =
        "Argument_NoRegionInvariantCulture";

    public const string Argument_NotAWritableProperty =
        "Argument_NotAWritableProperty";

    public const string Argument_NotEnoughBytesToRead =
        "Argument_NotEnoughBytesToRead";

    public const string Argument_NotEnoughBytesToWrite =
        "Argument_NotEnoughBytesToWrite";

    public const string Argument_NotEnoughGenArguments =
        "Argument_NotEnoughGenArguments";

    public const string Argument_NotExceptionType = "Argument_NotExceptionType";

    public const string Argument_NotInExceptionBlock =
        "Argument_NotInExceptionBlock";

    public const string Argument_NotMethodCallOpcode =
    ...
    public const string Argument_OffsetLocalMismatch =
        "Argument_OffsetLocalMismatch";

    public const string Argument_OffsetOfFieldNotFound =
    ...
    public const string Argument_OneOfCulturesNotSupported =
        "Argument_OneOfCulturesNotSupported";

    public const string Argument_OnlyMscorlib = "Argument_OnlyMscorlib";

    public const string Argument_OutOfOrderDateTimes =
    ...
    public const string Argument_RecursiveFallbackBytes =
        "Argument_RecursiveFallbackBytes";
    ...
    public const string Argument_ResolveFieldHandle =
    ...
    public const string Argument_ResultCalendarRange =
        "Argument_ResultCalendarRange";

    public const string Argument_SemaphoreInitialMaximum =
    ...
    public const string Argument_StringFirstCharIsZero =
        "Argument_StringFirstCharIsZero";

    public const string Argument_TimeSpanHasSeconds =
        "Argument_TimeSpanHasSeconds";

    public const string Argument_TimeZoneInfoBadTZif =
        "Argument_TimeZoneInfoBadTZif";

    public const string Argument_TimeZoneInfoInvalidTZif =
    ...
    public const string Argument_TooManyFinallyClause =
        "Argument_TooManyFinallyClause";

    public const string Argument_TransitionTimesAreIdentical =
        "Argument_TransitionTimesAreIdentical";

    public const string Argument_TypedReferenceInvalidField =
        "Argument_TypedReferenceInvalidField";

    public const string Argument_TypeMustNotBeComImport =
        "Argument_TypeMustNotBeComImport";

    public const string Argument_TypeNameTooLong = "Argument_TypeNameTooLong";

    public const string Argument_UnclosedExceptionBlock =
        "Argument_UnclosedExceptionBlock";

    public const string Argument_UnknownUnmanagedCallConv =
        "Argument_UnknownUnmanagedCallConv";

    public const string Argument_UnmanagedMemAccessorWrapAround =
        "Argument_UnmanagedMemAccessorWrapAround";

    public const string Argument_UnmatchedMethodForLocal =
        "Argument_UnmatchedMethodForLocal";

    public const string Argument_UnmatchingSymScope =
        "Argument_UnmatchingSymScope";

    public const string Argument_UTCOutOfRange = "Argument_UTCOutOfRange";

    public const string Argument_WaitHandleNameTooLong =
        "Argument_WaitHandleNameTooLong";

    public const string ArgumentException_BadMethodImplBody =
    ...
    public const string ArgumentOutOfRange_ActualValue =
        "ArgumentOutOfRange_ActualValue";

    public const string ArgumentOutOfRange_AddValue =
    ...
    public const string ArgumentOutOfRange_BadYearMonthDay =
    ...
    public const string ArgumentOutOfRange_CalendarRange =
        "ArgumentOutOfRange_CalendarRange";

    public const string ArgumentOutOfRange_Capacity =
        "ArgumentOutOfRange_Capacity";

    public const string ArgumentOutOfRange_Count = "ArgumentOutOfRange_Count";

    public const string ArgumentOutOfRange_DateArithmetic =
        "ArgumentOutOfRange_DateArithmetic";

    public const string ArgumentOutOfRange_DateTimeBadMonths =
        "ArgumentOutOfRange_DateTimeBadMonths";

    public const string ArgumentOutOfRange_DateTimeBadTicks =
        "ArgumentOutOfRange_DateTimeBadTicks";

    public const string ArgumentOutOfRange_TimeOnlyBadTicks =
        "ArgumentOutOfRange_TimeOnlyBadTicks";

    public const string ArgumentOutOfRange_DateTimeBadYears =
        "ArgumentOutOfRange_DateTimeBadYears";
    ...
    public const string ArgumentOutOfRange_DayParam =
        "ArgumentOutOfRange_DayParam";

    public const string ArgumentOutOfRange_DecimalRound =
    ...
    public const string ArgumentOutOfRange_FileTimeInvalid =
    ...
    public const string ArgumentOutOfRange_IndexMustBeLess =
    ...
    public const string ArgumentOutOfRange_IndexCount =
        "ArgumentOutOfRange_IndexCount";

    public const string ArgumentOutOfRange_IndexCountBuffer =
        "ArgumentOutOfRange_IndexCountBuffer";

    public const string ArgumentOutOfRange_IndexLength =
        "ArgumentOutOfRange_IndexLength";

    public const string ArgumentOutOfRange_IndexString =
        "ArgumentOutOfRange_IndexString";

    public const string ArgumentOutOfRange_InvalidEraValue =
    ...
    public const string ArgumentOutOfRange_InvalidUTF32 =
    ...
    public const string ArgumentOutOfRange_ListInsert =
        "ArgumentOutOfRange_ListInsert";

    public const string ArgumentOutOfRange_Month = "ArgumentOutOfRange_Month";

    public const string ArgumentOutOfRange_DayNumber =
        "ArgumentOutOfRange_DayNumber";

    public const string ArgumentOutOfRange_MonthParam =
        "ArgumentOutOfRange_MonthParam";

    public const string ArgumentOutOfRange_MustBeNonNegNum =
        "ArgumentOutOfRange_MustBeNonNegNum";

    public const string ArgumentOutOfRange_MustBePositive =
    ...
    public const string ArgumentOutOfRange_NeedValidId =
    ...
    public const string ArgumentOutOfRange_ParamSequence =
        "ArgumentOutOfRange_ParamSequence";

    public const string ArgumentOutOfRange_PartialWCHAR =
    ...
    public const string ArgumentOutOfRange_RoundingDigits =
    ...
    public const string ArgumentOutOfRange_StartIndex =
    ...
    public const string ArgumentOutOfRange_StreamLength =
        "ArgumentOutOfRange_StreamLength";

    public const string ArgumentOutOfRange_UIntPtrMax =
        "ArgumentOutOfRange_UIntPtrMax";
    ...
    public const string ArgumentOutOfRange_UtcOffset =
    ...
    public const string ArrayTypeMismatch_ConstrainedCopy =
    ...
    public const string BadImageFormat_NegativeStringLength =
    ...
    public const string BadImageFormat_ResourcesNameTooLong =
        "BadImageFormat_ResourcesNameTooLong";

    public const string BadImageFormat_TypeMismatch =
    ...
    public const string CancellationTokenSource_Disposed =
    ...
    public const string EventSource_AddScalarOutOfRange =
        "EventSource_AddScalarOutOfRange";
    ...
    public const string EventSource_DuplicateStringKey =
        "EventSource_DuplicateStringKey";

    public const string EventSource_EnumKindMismatch =
        "EventSource_EnumKindMismatch";

    public const string EventSource_EvenHexDigits = "EventSource_EvenHexDigits";

    public const string EventSource_EventChannelOutOfRange =
        "EventSource_EventChannelOutOfRange";
    ...
    public const string EventSource_EventNameReused =
        "EventSource_EventNameReused";

    public const string EventSource_EventParametersMismatch =
        "EventSource_EventParametersMismatch";

    public const string EventSource_EventSourceGuidInUse =
        "EventSource_EventSourceGuidInUse";
    ...
    public const string EventSource_IllegalKeywordsValue =
        "EventSource_IllegalKeywordsValue";

    public const string EventSource_IllegalOpcodeValue =
        "EventSource_IllegalOpcodeValue";

    public const string EventSource_IllegalTaskValue =
        "EventSource_IllegalTaskValue";
    ...
    public const string EventSource_InvalidEventFormat =
        "EventSource_InvalidEventFormat";

    public const string EventSource_KeywordCollision =
        "EventSource_KeywordCollision";

    public const string EventSource_KeywordNeedPowerOfTwo =
        "EventSource_KeywordNeedPowerOfTwo";

    public const string EventSource_ListenerCreatedInsideCallback =
        "EventSource_ListenerCreatedInsideCallback";

    public const string EventSource_ListenerNotFound =
        "EventSource_ListenerNotFound";

    public const string EventSource_ListenerWriteFailure =
        "EventSource_ListenerWriteFailure";

    public const string EventSource_MaxChannelExceeded =
        "EventSource_MaxChannelExceeded";

    public const string EventSource_MismatchIdToWriteEvent =
        "EventSource_MismatchIdToWriteEvent";
    ...
    public const string EventSource_NonCompliantTypeError =
        "EventSource_NonCompliantTypeError";

    public const string EventSource_NoRelatedActivityId =
    ...
    public const string EventSource_NotSupportedArrayOfNil =
        "EventSource_NotSupportedArrayOfNil";
    ...
    public const string EventSource_OpcodeCollision =
        "EventSource_OpcodeCollision";

    public const string EventSource_PinArrayOutOfRange =
        "EventSource_PinArrayOutOfRange";

    public const string EventSource_RecursiveTypeDefinition =
        "EventSource_RecursiveTypeDefinition";

    public const string EventSource_StopsFollowStarts =
        "EventSource_StopsFollowStarts";

    public const string EventSource_TaskCollision = "EventSource_TaskCollision";

    public const string EventSource_TaskOpcodePairReused =
    ...
    public const string EventSource_UndefinedChannel =
        "EventSource_UndefinedChannel";

    public const string EventSource_UndefinedKeyword =
        "EventSource_UndefinedKeyword";

    public const string EventSource_UndefinedOpcode =
        "EventSource_UndefinedOpcode";

    public const string EventSource_UnknownEtwTrait =
    ...
    public const string Exception_EndOfInnerExceptionStack =
    ...
    public const string FileNotFound_ResolveAssembly =
    ...
    public const string Format_GuidBraceAfterLastNumber =
    ...
    public const string Format_InvalidStringWithValue =
    ...
    public const string Format_UnexpectedClosingBrace =
    ...
    public const string Format_MissingIncompleteDate =
    ...
    public const string Format_RepeatDateTimePattern =
    ...
    public const string IndexOutOfRange_ArrayRankIndex =
        "IndexOutOfRange_ArrayRankIndex";

    public const string IndexOutOfRange_UMSPosition =
        "IndexOutOfRange_UMSPosition";

    public const string InsufficientMemory_MemFailPoint =
        "InsufficientMemory_MemFailPoint";
    ...
    public const string Interop_Marshal_Unmappable_Char =
    ...
    public const string InvalidOperation_AsyncIOInProgress =
        "InvalidOperation_AsyncIOInProgress";

    public const string InvalidOperation_BadEmptyMethodBody =
    ...
    public const string InvalidOperation_BadMethodBody =
        "InvalidOperation_BadMethodBody";

    public const string InvalidOperation_BadTypeAttributesNotAbstract =
        "InvalidOperation_BadTypeAttributesNotAbstract";

    public const string InvalidOperation_CalledTwice =
    ...
    public const string InvalidOperation_DateTimeParsing =
    ...
    public const string InvalidOperation_HandleIsNotPinned =
        "InvalidOperation_HandleIsNotPinned";

    public const string InvalidOperation_HashInsertFailed =
        "InvalidOperation_HashInsertFailed";

    public const string InvalidOperation_IComparerFailed =
        "InvalidOperation_IComparerFailed";

    public const string InvalidOperation_MethodBaked =
        "InvalidOperation_MethodBaked";

    public const string InvalidOperation_MethodBuilderBaked =
        "InvalidOperation_MethodBuilderBaked";

    public const string InvalidOperation_MethodHasBody =
        "InvalidOperation_MethodHasBody";

    public const string InvalidOperation_MustCallInitialize =
    ...
    public const string InvalidOperation_NoPublicAddMethod =
        "InvalidOperation_NoPublicAddMethod";

    public const string InvalidOperation_NoPublicRemoveMethod =
        "InvalidOperation_NoPublicRemoveMethod";

    public const string InvalidOperation_NotADebugModule =
    ...
    public const string InvalidOperation_NotGenericType =
    ...
    public const string InvalidOperation_NullContext =
        "InvalidOperation_NullContext";

    public const string InvalidOperation_NullModuleHandle =
        "InvalidOperation_NullModuleHandle";

    public const string InvalidOperation_OpenLocalVariableScope =
        "InvalidOperation_OpenLocalVariableScope";

    public const string InvalidOperation_Overlapped_Pack =
    ...
    public const string InvalidOperation_SetLatencyModeNoGC =
        "InvalidOperation_SetLatencyModeNoGC";
    ...
    public const string InvalidOperation_TimerAlreadyClosed =
        "InvalidOperation_TimerAlreadyClosed";

    public const string InvalidOperation_TypeHasBeenCreated =
        "InvalidOperation_TypeHasBeenCreated";

    public const string InvalidOperation_TypeNotCreated =
    ...
    public const string InvalidOperation_UnknownEnumType =
    ...
    public const string InvalidTimeZone_InvalidFileData =
        "InvalidTimeZone_InvalidFileData";

    public const string InvalidTimeZone_InvalidJulianDay =
        "InvalidTimeZone_InvalidJulianDay";

    public const string InvalidTimeZone_NoTTInfoStructures =
    ...
    public const string IO_NoFileTableInInMemoryAssemblies =
    ...
    public const string IO_DiskFull_Path_AllocationSize =
        "IO_DiskFull_Path_AllocationSize";

    public const string IO_FileTooLarge_Path_AllocationSize =
        "IO_FileTooLarge_Path_AllocationSize";
    ...
    public const string IO_TooManySymbolicLinkLevels =
    ...
    public const string Lazy_StaticInit_InvalidOperation =
        "Lazy_StaticInit_InvalidOperation";

    public const string Lazy_ToString_ValueNotCreated =
        "Lazy_ToString_ValueNotCreated";

    public const string Lazy_Value_RecursiveCallsToValue =
    ...
    public const string NotSupported_AbstractNonCLS =
        "NotSupported_AbstractNonCLS";

    public const string NotSupported_ActivAttr = "NotSupported_ActivAttr";

    public const string NotSupported_AssemblyLoadFromHash =
        "NotSupported_AssemblyLoadFromHash";

    public const string NotSupported_ByRefLike = "NotSupported_ByRefLike";

    public const string NotSupported_ByRefToByRefLikeReturn =
        "NotSupported_ByRefToByRefLikeReturn";

    public const string NotSupported_ByRefToVoidReturn =
        "NotSupported_ByRefToVoidReturn";
    ...
    public const string NotSupported_DynamicAssembly =
        "NotSupported_DynamicAssembly";

    public const string NotSupported_DynamicMethodFlags =
        "NotSupported_DynamicMethodFlags";

    public const string NotSupported_DynamicModule = "NotSupported_DynamicModule";

    public const string NotSupported_FixedSizeCollection =
    ...
    public const string NotSupported_IllegalOneByteBranch =
        "NotSupported_IllegalOneByteBranch";

    public const string NotSupported_KeyCollectionSet =
        "NotSupported_KeyCollectionSet";

    public const string NotSupported_MaxWaitHandles =
        "NotSupported_MaxWaitHandles";

    public const string NotSupported_MemStreamNotExpandable =
        "NotSupported_MemStreamNotExpandable";

    public const string NotSupported_MustBeModuleBuilder =
        "NotSupported_MustBeModuleBuilder";

    public const string NotSupported_NoCodepageData =
    ...
    public const string NotSupported_NonReflectedType =
    ...
    public const string NotSupported_ObsoleteResourcesFile =
        "NotSupported_ObsoleteResourcesFile";

    public const string NotSupported_OutputStreamUsingTypeBuilder =
        "NotSupported_OutputStreamUsingTypeBuilder";

    public const string NotSupported_RangeCollection =
    ...
    public const string NotSupported_StringComparison =
    ...
    public const string NotSupported_TypeNotYetCreated =
        "NotSupported_TypeNotYetCreated";

    public const string NotSupported_UmsSafeBuffer = "NotSupported_UmsSafeBuffer";

    public const string NotSupported_UnitySerHolder =
        "NotSupported_UnitySerHolder";

    public const string NotSupported_UnreadableStream =
        "NotSupported_UnreadableStream";

    public const string NotSupported_UnseekableStream =
        "NotSupported_UnseekableStream";

    public const string NotSupported_UnwritableStream =
    ...
    public const string ObjectDisposed_ObjectName_Name =
        "ObjectDisposed_ObjectName_Name";

    public const string ObjectDisposed_WriterClosed =
        "ObjectDisposed_WriterClosed";

    public const string ObjectDisposed_ReaderClosed =
        "ObjectDisposed_ReaderClosed";

    public const string ObjectDisposed_ResourceSet = "ObjectDisposed_ResourceSet";

    public const string ObjectDisposed_StreamClosed =
        "ObjectDisposed_StreamClosed";

    public const string ObjectDisposed_ViewAccessorClosed =
    ...
    public const string Overflow_TimeSpanElementTooLarge =
    ...
    public const string PlatformNotSupported_ArgIterator =
        "PlatformNotSupported_ArgIterator";

    public const string PlatformNotSupported_ComInterop =
    ...
    public const string PlatformNotSupported_OSXFileLocking =
        "PlatformNotSupported_OSXFileLocking";

    public const string PlatformNotSupported_ReflectionOnly =
        "PlatformNotSupported_ReflectionOnly";

    public const string PlatformNotSupported_Remoting =
        "PlatformNotSupported_Remoting";
    ...
    public const string PlatformNotSupported_OverlappedIO =
        "PlatformNotSupported_OverlappedIO";

    public const string PlatformNotSupported_AppDomains =
        "PlatformNotSupported_AppDomains";

    public const string PlatformNotSupported_CAS = "PlatformNotSupported_CAS";

    public const string PlatformNotSupported_Principal =
        "PlatformNotSupported_Principal";

    public const string PlatformNotSupported_ThreadAbort =
        "PlatformNotSupported_ThreadAbort";

    public const string PlatformNotSupported_ThreadSuspend =
    ...
    public const string PostconditionOnExceptionFailed =
        "PostconditionOnExceptionFailed";

    public const string PostconditionOnExceptionFailed_Cnd =
    ...
    public const string Security_CannotReadFileData =
        "Security_CannotReadFileData";

    public const string SemaphoreSlim_ctor_InitialCountWrong =
        "SemaphoreSlim_ctor_InitialCountWrong";

    public const string SemaphoreSlim_ctor_MaxCountWrong =
        "SemaphoreSlim_ctor_MaxCountWrong";

    public const string SemaphoreSlim_Release_CountWrong =
        "SemaphoreSlim_Release_CountWrong";

    public const string SemaphoreSlim_Wait_TimeoutWrong =
        "SemaphoreSlim_Wait_TimeoutWrong";

    public const string Serialization_BadParameterInfo =
    ...
    public const string Serialization_DelegatesNotSupported =
        "Serialization_DelegatesNotSupported";

    public const string Serialization_InsufficientState =
        "Serialization_InsufficientState";

    public const string Serialization_InvalidData = "Serialization_InvalidData";

    public const string Serialization_InvalidEscapeSequence =
    ...
    public const string Serialization_MissingDateTimeData =
        "Serialization_MissingDateTimeData";

    public const string Serialization_MissingKeys = "Serialization_MissingKeys";

    public const string Serialization_MissingValues =
        "Serialization_MissingValues";

    public const string Serialization_NoParameterInfo =
    ...
    public const string Serialization_SameNameTwice =
        "Serialization_SameNameTwice";

    public const string Serialization_StringBuilderCapacity =
    ...
    public const string SpinLock_IsHeldByCurrentThread =
        "SpinLock_IsHeldByCurrentThread";
    ...
    public const string Task_FromAsync_PreferFairness =
        "Task_FromAsync_PreferFairness";
    ...
    public const string Task_MultiTaskContinuation_NullTask =
    ...
    public const string Task_RunSynchronously_Continuation =
        "Task_RunSynchronously_Continuation";

    public const string Task_RunSynchronously_Promise =
        "Task_RunSynchronously_Promise";

    public const string Task_RunSynchronously_TaskCompleted =
        "Task_RunSynchronously_TaskCompleted";

    public const string Task_Start_AlreadyStarted = "Task_Start_AlreadyStarted";

    public const string Task_Start_ContinuationTask =
    ...
    public const string Threading_AbandonedMutexException =
        "Threading_AbandonedMutexException";
    ...
    public const string Threading_WaitHandleTooManyPosts =
        "Threading_WaitHandleTooManyPosts";

    public const string Threading_SemaphoreFullException =
    ...
    public const string ThreadLocal_ValuesNotAvailable =
        "ThreadLocal_ValuesNotAvailable";

    public const string TimeZoneNotFound_MissingData =
    ...
    public const string TypeLoad_ResolveTypeFromAssembly =
    ...
    public const string UnauthorizedAccess_IODenied_Path =
        "UnauthorizedAccess_IODenied_Path";

    public const string UnauthorizedAccess_MemStreamBuffer =
    ...
    public const string HashCode_HashCodeNotSupported =
        "HashCode_HashCodeNotSupported";

    public const string HashCode_EqualityNotSupported =
    ...
    public const string Arg_BasePathNotFullyQualified =
    ...
    public const string Argument_OverlapAlignmentMismatch =
        "Argument_OverlapAlignmentMismatch";

    public const string Arg_MustBeNullTerminatedString =
        "Arg_MustBeNullTerminatedString";

    public const string ArgumentOutOfRange_Week_ISO =
        "ArgumentOutOfRange_Week_ISO";

    public const string Argument_BadPInvokeMethod = "Argument_BadPInvokeMethod";

    public const string Argument_BadPInvokeOnInterface =
        "Argument_BadPInvokeOnInterface";

    public const string Argument_MethodRedefined = "Argument_MethodRedefined";

    public const string Argument_CannotExtractScalar =
        "Argument_CannotExtractScalar";

    public const string Argument_CannotParsePrecision =
        "Argument_CannotParsePrecision";

    public const string Argument_GWithPrecisionNotSupported =
        "Argument_GWithPrecisionNotSupported";
    ...
    public const string Argument_SpansMustHaveSameLength =
    ...
    public const string Argument_BadResourceScopeTypeBits =
        "Argument_BadResourceScopeTypeBits";
    ...
    public const string Argument_EmptyOrWhiteSpaceString =
        "Argument_EmptyOrWhiteSpaceString";

    public const string Argument_FrameworkNameInvalid =
    ...
    public const string Argument_FrameworkNameTooShort =
        "Argument_FrameworkNameTooShort";

    public const string Arg_SwitchExpressionException =
        "Arg_SwitchExpressionException";

    public const string Arg_ContextMarshalException =
        "Arg_ContextMarshalException";

    public const string Arg_AppDomainUnloadedException =
    ...
    public const string Activator_CannotCreateInstance =
        "Activator_CannotCreateInstance";

    public const string ResourceManager_ReflectionNotAllowed =
        "ResourceManager_ReflectionNotAllowed";

    public const string InvalidOperation_EmptyQueue =
    ...
    public const string IO_SourceDestMustBeDifferent =
        "IO_SourceDestMustBeDifferent";

    public const string PlatformNotSupported_FileEncryption =
        "PlatformNotSupported_FileEncryption";

    public const string Arg_MemberInfoNotFound = "Arg_MemberInfoNotFound";

    public const string NullabilityInfoContext_NotSupported =
        "NullabilityInfoContext_NotSupported";

    public const string NullReference_InvokeNullRefReturned =
        "NullReference_InvokeNullRefReturned";
    ...
    public const string PlatformNotSupported_ReflectionEmit =
        "PlatformNotSupported_ReflectionEmit";

    public const string Security_InvalidAssemblyPublicKey =
        "Security_InvalidAssemblyPublicKey";
    ...
    public const string Argument_DirectorySeparatorInvalid =
        "Argument_DirectorySeparatorInvalid";

    public const string InvalidOperation_NotFunctionPointer =
        "InvalidOperation_NotFunctionPointer";
    ...
    //                 if (_currentlyLoading != null && _currentlyLoading.Count >
    //                 0 && _currentlyLoading.LastIndexOf(key) >= 0)
    //                 {
    ...
    // var message = $"Encountered infinite recursion while looking up resource
    // '{key}' in System.Private.CoreLib. Verify the installation of .NET is
    // complete and does not need repairing, and that the state of the process has
    // not become corrupted."; Environment.FailFast(message);
    //                 }
    ...
    static string Format(IFormatProvider provider, string resourceFormat,
                         object p1)
    {
        if (UsingResourceKeys())
        {
