...
#endif
public interface IStringWithRegexValueObject<TSelf> : IComparable<TSelf>,
                                                      IComparable,
                                                      IEquatable<TSelf>,
                                                      IHaveAUri
  ...
  /// <summary>
  /// The value of the value object as a string.  Will be <see langword="null"
  /// /> or <see cref="string.Empty" /> iff <see cref="IsEmpty" /> == <see
  /// langword="true" />
  /// </summary>
  string Value { get; }

  /// <summary>
  /// <see langword="true" /> if the value object is empty, <see
  ...
  /// </summary>
  /// <returns>a <see cref="Regex" /> containing the regular expression, which
  /// can be used to parse/validate string versions of the value
  /// object</returns>
  ...
  /// </summary>
  /// <returns>the regular expression (as a string), which can be used to
  /// parse/validate string versions of the value object</returns>
  ...
  /// </summary>
  /// <returns>an instance of <typeparamref name="TSelf" /> iff the <see
  /// langword="string" /> <paramref name="value" /> parses properly</returns>
  /// <exception cref="global::Vogen.ValueObjectValidationException">thrown if
  /// the value object fails validation</exception> <exception
  /// cref="global::System.Exception">thrown if parsing the <see
  /// langword="string" /> <paramref name="value" /> failed for some other
  /// reason</exception>
