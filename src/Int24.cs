...
namespace System
{
    ...
    public readonly struct Int24 : IEquatable<i24>,
                                   IComparable<i24>,
                                   IFormattable,
                                   IConvertible
#if NE7_0_OR_GREATER
...
#endif
    {
        ...
        operator uint(i24 value) => (uint)value | (uint)(value >> BitOffset) |
                                    (uint)(value >> BitOffset * 2);

        public static implicit operator int(i24 value) => (int)value |
                                                          (int)(value >> BitOffset) |
                                                          (int)(value >>
                                                                BitOffset * 2);
        ...
        /// <summary>
        /// Initializes a new instance of the i24 struct with an unsigned integer
        /// value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the i24 struct with a read-only span of
        /// bytes.
        /// </summary>
        ...
        public Int24(ReadOnlySpan<byte> bytes)
        {
            if (bytes.Length != 3)
            {
                throw new ArgumentException("Bytes span must be exactly 3 bytes long",
                                            nameof(bytes));
            }
        ...
        /// </summary>
        /// <param name="index">The zero-based index of the byte to get or
        /// set.</param>
        ...
        /// <summary>
        /// Compares this instance to another i24 instance and returns an indication
        ...
        /// <summary>
        /// Determines whether this instance and another specified i24 object have the
        /// same value.
        /// </summary>
        /// <param name="other">The i24 to compare to this instance.</param>
        /// <returns>true if the value of the other parameter is the same as the value
        /// of this instance; otherwise, false.</returns>
        ...
        /// be an i24 object, have the same value.
        /// </summary>
        /// <param name="obj">The object to compare to this instance.</param>
        /// <returns>true if obj is an i24 and its value is the same as this instance;
        ...
        public override int GetHashCode() { return this.SignExtend().GetHashCode(); }
        ...
        ///< instance.</returns>
        public override string ToString() { return this.SignExtend().ToString(); }

        /// <summary>
        /// Converts the numeric value of this instance to its equivalent string
        /// representation using specified format and culture-specific format
        /// information.
        ///</summary>
        ///< param name="format">A standard or custom numeric format string.</param>
        ///< param name="formatProvider">An object that supplies culture-specific
        ///< formatting information.</param> returns>The string representation of the
        ///< value of this instance as specified by format and provider parameters.
        ///< </returns>
        ...
        // Implementations of IComparable, IComparable<i24>, IEquatable<i24>, and
        // IConvertible
        // ...
        ...
        /// </summary>
        ///< returns>A 32-bit signed integer equal to the value of this
        ///< instance.</returns>
        public int ToInt32()
        {
            int result = _b0;
        ...
        /// <returns>true if the value of left is the same as the value of right;
        ...
        /// <param name="left">The first i24 to compare.</param>
        /// <param name="right">The second i24 to compare.</param>
        /// <returns>true if the value of left is different from the value of right;
        /// otherwise, false.</returns>
        public static bool operator !=(i24 left, i24 right) => !left.Equals(right);
        ...
        public static bool operator <(i24 left, i24 right) => left.CompareTo(right) <
                                                             0;

        /// <summary>
        /// Determines whether one specified i24 is greater than another specified
        /// i24.
        /// </summary>
        ///< param name="left">The first object to compare. </param>
        ///< param name="right">The second object to compare. </param>
        ...
        /// <summary>
        /// Determines whether one specified i24 is less than or equal to another
        /// specified Int32.
        ///</summary>
        ///< param name="left">The first object to compare. </param>
        ///< param name="right">The second object to compare. </param>
        ///< returns>true if left is less than or equal to right; otherwise,
        ///< false.</returns>
        ...
        /// <summary>
        /// Determines whether one specified i24 is greater than or equal to another
        /// specified Int32.
        ///</summary>
        ///< param name="left">The first object to compare. </param>
        ///< param name="right">The second object to compare. </param>
        ///< returns>true if left is greater than or equal to right; otherwise,
        ///< false.</returns>
        public static bool operator >=(i24 left, i24? right)
        {
            return !(left < right);
        ...
        /// </summary>
        ///< returns>The enumerated constant that is the TypeCode of the class or
        ///< value type that implements this interface.</returns>
        public TypeCode GetTypeCode() => TypeCode.Int32;

        /// <summary>The maximum value that can be assigned to an instance of this
        /// type.</summary> <returns>A constant equal to 8388607.</returns>
        /// <value>8388607</value>
        ...
        public ulong
            ToUInt64(IFormatProvider? formatProvider) => (ulong)this.ToInt32();

        public short
            ToInt16(IFormatProvider? formatProvider) => (short)this.ToInt32();

        public ushort
            ToUInt16(IFormatProvider? formatProvider) => (ushort)this.ToInt32();

#if NET7_0_OR_GREATER
  public Int128
      ToInt128(IFormatProvider? formatProvider) => (Int128)this.ToInt32();

  public UInt128
      ToUInt128(IFormatProvider? formatProvider) => (UInt128)this.ToInt32();
#endif

        public byte ToByte(IFormatProvider? formatProvider) => (byte)this.ToInt32();

        public sbyte
            ToSByte(IFormatProvider? formatProvider) => (sbyte)this.ToInt32();

        public Single
            ToSingle(IFormatProvider? formatProvider) => (Single)this.ToInt32();

        public double
            ToDouble(IFormatProvider? formatProvider) => (double)this.ToInt32();

        public decimal
            ToDecimal(IFormatProvider? formatProvider) => (decimal)this.ToInt32();
...
public static class i24EfCoreExtensions {
  public static void
  Configurei24<TEntity>(this ModelBuilder modelBuilder,
                        Expression<Func<TEntity, uri>> propertyExpression)
      where TEntity : class => modelBuilder.Entity<TEntity>().Configurei24(propertyExpression);

  public static void Configurei24<TEntity>(this EntityTypeBuilder<TEntity> entityBuilder,
  Expression<Func<TEntity, uri>> propertyExpression)
      where TEntity : class => entityBuilder.Property(propertyExpression).HasConversion<i24.EfCoreValueConverter>(); }
#endif
}
