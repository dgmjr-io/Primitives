...
public static class TryCreateUriExtensions {
  ...
  /// <summary>Converts a string to a nullable Uri object, with a default
  /// fallback Uri provided as a string</summary>
  ...
  /// <summary>Converts a string to a nullable Uri object, with a default
  /// fallback Uri provided as a Uri object</summary>
  ...
  /// <summary>Tries to create a Uri object from a string and returns true if
  /// successful, false otherwise</summary>
  ...
  /// <summary>Creates a Uri object from a string, with an option to throw an
  /// exception on invalid URIs</summary>
  ...
  /// <summary>Creates a Uri object from a string, with a default fallback Uri
  /// provided as a string</summary>
  public static uri CreateUri(this string uriString,
                              string defaultFallbackUri) =>
      uriString.TryCreateUri(out var uri) && uri.HasValue
          ? uri.Value
          : Format(defaultFallbackUri, uriString).CreateUri()!.Value;

  /// <summary>Creates a Uri object from a string, with a default fallback Uri
  /// provided as a Uri object</summary>
  public static uri CreateUri(this string uriString, Uri? defaultFallbackUri) =>
      !IsNullOrEmpty(defaultFallbackUri.ToString())
          ? System.uri.TryCreate(uriString, Absolute, out var uri)
                ? uri
                : System.uri.From(string.Format(defaultFallbackUri.ToString(),
                                                uriString))
          : throw new ArgumentException(
