...
D" : "")}{(dtd.Hours.HasValue || dtd.Minutes.HasValue || dtd.Seconds.HasValue ? "T" : "")}{(dtd.Hours.HasValue ? $" {dtd.Hours.Value
}
H " : "")}{(dtd.Minutes.HasValue ? $" { dtd.Minutes.Value}
M " : "")}{(dtd.Seconds.HasValue ? $" { dtd.Seconds.Value}
S " : "")}";
}
