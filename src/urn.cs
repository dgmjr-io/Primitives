...
public readonly partial record struct urn : IStringWithRegexValueObject<urn>,
                                            IResourceIdentifier
...
#endif
{
  ...
  public class SystemTextJsonConverter : JsonConverter<urn> {
    ...
    public override void Write(Utf8JsonWriter writer, urn value,
                               JsonSerializerOptions options) {
      writer.WriteStringValue(value.ToString());
    }
  }
...
public static class UrnEfCoreExtensions {
  public static void
  ConfigureUrn<TEntity>(this ModelBuilder modelBuilder,
  ...
  public static void ConfigureUrn<TEntity>(this EntityTypeBuilder<TEntity> entityBuilder,
  Expression<Func<TEntity, urn>> propertyExpression)
      where TEntity : class => entityBuilder.Property(propertyExpression).HasConversion<urn.EfCoreValueConverter>(); }
#endif
