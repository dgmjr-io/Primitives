...
public interface IRegexGuardedString<TSelf, TRegexProvider>
    : IRegexGuardedString<TRegexProvider>
...
public class RegexGuardedString<TSelf, TRegexProvider>
    : RegexGuardedString<TSelf>, IRegexGuardedString<TSelf, TRegexProvider>
  ...
  //     Serialization.JsonConverter<RegexGuardedString>
  //     {
  //         public override RegexGuardedString Read(ref Utf8JsonReader reader,
  ...
  //             {
  //                 throw new JsonException($"Could not convert the value at
  //                 index {reader.TokenStartIndex} to an object of type
  //                 {nameof(RegexGuardedString)}; unexpected token:
  //                 {reader.TokenType}");
  //             }
  ...
  //                 }
  //             }
  //             throw new JsonException($"Could not convert the value at index
  //             {reader.TokenStartIndex} to an object of type
  //             {nameof(RegexGuardedString)}: unknown error.");
  //         }

  //         public override void Write(Utf8JsonWriter writer,
  //         RegexGuardedString value, JsonSerializerOptions options)
  //         {
...
public class RegexGuardedString<TSelf> : IRegexGuardedString<TSelf>
  ...
  //     {
  //         public override TSelf Read(ref Text.Json.Utf8JsonReader reader,
  //         Type typeToConvert, Text.Json.JsonSerializerOptions options)
  //         {
  //             string value = default!;
  //             string pattern = default!;
  //             RegexOptions options = None;

  //             if (reader.TokenType is not JsonTokenType.StartObject or
  ...
  //                     RegexGuardedString<TSelf>.Regex().ToString()) && value
  //                     is not null)
  //                     {
  //                         return (TSelf)CreateInstance(typeof(TSelf), value);
  //                     }
  //                     else
  //                     {
  //                         throw new JsonException($"Could not convert the
  //                         value at index {reader.TokenStartIndex} to an
  //                         object of type {typeof(TSelf).Name}. A pattern was
  //                         speficied (\"{pattern}\") but it did not match the
  //                         expected pattern: \"{new
  //                         RegexGuardedString<TSelf>().Regex()}\"");
  //                     }
  //                 }

  //                 if (reader.TokenType != JsonTokenType.PropertyName)
  //                 {
  //                     throw new JsonException($"Could not convert the value
  //                     at index {reader.TokenStartIndex} to an object of type
  //                     {typeof(TSelf).Name}; unexpected token:
  //                     {reader.TokenType}");
  //                 }
  ...
  //             throw new JsonException($"Could not convert the value at index
  //             {reader.TokenStartIndex} to an object of type
  //             {nameof(RegexGuardedString<TSelf>)}.");
  //         }

  //         public override void Write(Utf8JsonWriter writer, TSelf value,
